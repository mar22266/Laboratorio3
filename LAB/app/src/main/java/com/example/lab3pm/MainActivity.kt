...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnOption2: Button = findViewById(R.id.btnOption2) // Corregido
        btnOption2.setOnClickListener {
            val intent = Intent(this@MainActivity, ThirdActivity::class.java)
            startActivity(intent)
        }

        val btnOption3: Button = findViewById(R.id.btnOption3) // Corregido
        btnOption3.setOnClickListener {
            val intent = Intent(this@MainActivity, FourthActivity::class.java)
            startActivity(intent)
        }

        val btnOption4: Button = findViewById(R.id.btnOption4) // Agregado
        btnOption4.setOnClickListener {
            val intent = Intent(this@MainActivity, FifthActivity::class.java)
            startActivity(intent)
        }

        val btnOption5: Button = findViewById(R.id.btnOption5) // Agregado
